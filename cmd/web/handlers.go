...
func (app *Config) PostLoginPage(w http.ResponseWriter, r *http.Request) {
	...
	user, err := app.Models.User.ByEmail(email)
	if err != nil {
...
func (app *Config) ActivateAccount(w http.ResponseWriter, r *http.Request) {
	...
	//activate account
	u, err := app.Models.User.ByEmail(r.URL.Query().Get("email"))
	if err != nil {
...
func (app *Config) SubscribeToPlan(w http.ResponseWriter, r *http.Request) {
	...
	u, err := app.Models.User.ById(user.ID)
	if err != nil {
...
func (app *Config) printSessionValue(r *http.Request, key string) {
	value := app.Session.Get(r.Context(), key)
